...
const reduxLogger = require('redux-logger') //A middleware for logging everything happening in redux
...
const unsubscribe = store.subscribe(() => {});  //the logger middleware handles the states display...
